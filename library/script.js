...
const books = {
    ...
    */
    book1: [
        ...
        "Here's a list of some of my <b>favorites:</b><br>• Animals — Hedgehogs, frogs, and ducks<br>• Anime — Toilet-Bound Hanako-kun<br>• Chips — Cheddar & Sour Cream Ruffles and Cheetos Puffs<br>• Color — Aquamarine (hex #00ffae)<br>• Foods — Bistek, daing na bangus, gyudon, and takoyaki<br>• Holiday — Christmas 🎄<br>• Manga — Toilet-Bound Hanako-kun<br>• Music Artists — Snail's House, Kirara Magic, and Shion Lee<br>• Music Genre — Kawaii future bass and EDM<br>• Pokémon — Shaymin and Shuckle<br>• Sport — None<br>• Video Games — Roblox, Genshin Impact, and BanG Dream!",
