...
const customerNames = [
    ...
    /*NunnerLibrary*/	"Pinky", "Mint", "Hope", "Noah", "Richard", "Marcus", "Sasha", "Billy", "Bob", "Joe", "Liva", "Cory", "Eve", "Cole", "Phoebe", "Sarah", "Saki", "Micah", "Whiskey Pete", "Valentine", "Morgan O'Connell", "Buddy Hawkins", "Warami", "Tatakashi", "Akari", "Hikari", "Kaitou", "Mahou",
	...
	/*Genshin*/			"Aether", "Albedo", "Amber", "Arataki Itto", "Barbara", "Beidou", "Bennett", "Candace", "Charlotte", "Chasca", "Chevreuse", "Chongyun", "Citlali", "Collei", "Cyno", "Dainsleif", "Dehya", "Diluc", "Diona", "Dori", /*"Escoffier",*/ "Eula", "Faruzan", "Fiscl", "Freminet", "Furina", "Gaming", "Ganyu", "Gorou", "Hu Tao", "Iansan", "Ifa", "Kachina", "Kaedehara Kazuha", "Kaeya", "Kamisato Ayaka", "Kamisato Ayato", "Keqing", "Kinich", "Klee", "Kujou Sara", "Kuki Shinobu", "Lan Yan", "Layla", "Lisa", "Lumine", "Lynette", "Lyney", "Mavuika", "Mika", "Mona", "Mualani", "Nahida", "Navia", "Neuvillette", "Nilou", "Ningguang", "Noelle", "Ororon", "Paimon", "Qiqi", "Raiden Shogun", "Razor", "Rosaria", "Sangonomiya Kokomi", "Sayu", "Shenhe", "Shikanoin Heizou", "Sucrose", "Tartaglia", "Thoma", "Tighnari", "Traveler", "Varesa", "Venti", "Wanderer", "Wriothesley", "Xiangling", "Xianyun", "Xiao", "Xilonen", "Xingqiu", "Xinyan", "Yae Miko", "Yanfei", "Yaoyao", "Yelan", "Yoimiya", "Yumemizuki Mizuki", "Yun Jin", "Zhongli",
